...
def action_on_plural(syn):
    ...
    if lemma_syn.endswith("s") or lemma_syn.endswith("ss") or lemma_syn.endswith("sh") or lemma_syn.endswith("ch") or lemma_syn.endswith("x") or \
                        ...
                        if word_approved(compare_token):
                            ...
                            if syn_vs_synsets:
                                ...
                                for compare_synset in compare_synsets:
                                    ...
                                    num_cmp = num_cmp + 1
                                    try:
                                        print("I'm comparing " + syn_name_final + " with " + compare_syn_name_final)
                                ...
                                num_cmp = num_cmp + 1
                                try:
                                    print("I'm comparing " + syn_name_final + " with " + compare_token.text.lower())
