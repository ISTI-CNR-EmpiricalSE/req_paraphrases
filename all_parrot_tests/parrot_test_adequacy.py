...
adequacy_array = [0.1, 0.5, 0.99]

dir = "../results/parameters/adequacy/first"
...
for current_adequacy in adequacy_array:
    tic2 = time.perf_counter()

    # examples
    # results/parameters/diversity_ranker_1
    # results/parameters/diversity_ranker_2
    f = open(dir + "/" + "adequacy_" + str(file_index) + ".txt", "w")
    ...
    f.write("\n")
    f.write("adequacy = " + str(current_adequacy) + "\n")
    f.write("\n")
    phrase_index = 1
    for phrase in phrases:
        ...
        para_phrases = parrot.augment(input_phrase=phrase,
                                      ...
                                      max_length=32,
                                      adequacy_threshold=current_adequacy,
...
f = open(dir + "/" + "adequacy_" + str(file_index - 1) + ".txt", "a")
f.write("\n")
