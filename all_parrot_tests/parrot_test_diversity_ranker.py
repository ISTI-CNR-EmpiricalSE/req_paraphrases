...
dir = "../results/parameters/diversity_ranker/first"
...
for current_diversity_ranker in diversity_ranker_array:
    ...
    f.write("adequacy_threshold = 0.99\n")
    f.write("fluency_threshold = 0.90\n")
    f.write("\n")
...
f = open(dir + "/" + "diversity_ranker_" + str(file_index - 1) + ".txt", "a")
f.write("\n")
