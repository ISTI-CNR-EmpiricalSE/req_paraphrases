...
dir = "../results/parameters/max_return_phrases/second"
...
for current_number_of_return_phrases in max_return_phrases_array:
    ...
    # examples
    # results/parameters/max_return_phrases_1
    # results/parameters/max_return_phrases_2
...
f = open(dir + "/" + "max_return_phrases_" + str(file_index - 1) + ".txt", "a")
f.write("\n")
