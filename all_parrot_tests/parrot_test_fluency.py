...
fluency_array = [0.1, 0.5, 0.99]

dir = "../results/parameters/fluency/first"
...
for current_fluency in fluency_array:
    ...
    f.write("adequacy = 0.5\n")
    f.write("\n")
    f.write("fluency = " + str(current_fluency) + "\n")
    f.write("\n")
    phrase_index = 1
    for phrase in phrases:
        ...
        para_phrases = parrot.augment(input_phrase=phrase,
                                      ...
                                      fluency_threshold=current_fluency)
...
f = open(dir + "/" + "fluency_" + str(file_index - 1) + ".txt", "a")
f.write("\n")
